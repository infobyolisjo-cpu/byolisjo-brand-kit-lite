...
/* Handler robusto: soporta n por query o body y nunca hace throw */
export async function POST(req: Request) {
  try {
    // Lee n desde ?n= y también desde body.n por si acaso
    let n = 1;
    try {
    ...
    if (!prompt.trim()) {
      // el cliente espera array; devolvemos vacío si no hay prompt
    ...
    // Nunca dejamos caer 500 al cliente
